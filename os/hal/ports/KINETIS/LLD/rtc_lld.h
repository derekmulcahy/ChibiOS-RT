 ...
 */
#define RTC_ALARMS                  1
/* FIXME: rtc.h depends on STM32_RTC_NUM_ALARMS */
#define STM32_RTC_NUM_ALARMS        RTC_ALARMS
 ...
 */
#define KINETIS_RTC_IRQ_PRIORITY      15
/** @} */
...
#if HAL_USE_RTC && !KINETIS_HAS_RTC
